...
TYPED_TEST(PhotosChangeLog, tagsManipulation)
{
    // add new photo
    Photo::DataDelta pd;
    pd.insert<Photo::Field::Path>(UnitTests::makeLocation("photo1.jpeg"));
...
TYPED_TEST(PhotosChangeLog, groupsManipulation)
{
    ...
    pd0.insert<Photo::Field::Path>(UnitTests::makeLocation("photo0.jpeg"));
    ...
    pd3.insert<Photo::Field::Path>(UnitTests::makeLocation("photo1.jpeg"));
    pd4.insert<Photo::Field::Path>(UnitTests::makeLocation("photo4.jpeg"));
    pd5.insert<Photo::Field::Path>(UnitTests::makeLocation("photo5.jpeg"));
