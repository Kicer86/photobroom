...
namespace Database
{
    ...
    struct IAnyPhotoTask
    {
        virtual ~IAnyPhotoTask() {}
    ...
    struct IDatabase
    {
        ...
        virtual void exec(std::unique_ptr<IAnyPhotoTask> &&, const std::deque<IFilter::Ptr> &) = 0;       //is there any photo matching filters?
