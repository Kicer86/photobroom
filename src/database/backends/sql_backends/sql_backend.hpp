...
namespace Database
{
    ...
    class SQL_BACKEND_BASE_EXPORT ASqlBackend: public Database::IBackend
    {
        ...
        private:
            ...
            virtual TagValue::List listTagValues(const TagNameInfo &, const std::deque<IFilter::Ptr> &) override final;
            ...
            virtual bool anyPhoto(const std::deque<IFilter::Ptr> &) override final;
