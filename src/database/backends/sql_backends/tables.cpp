...
namespace Database
{
        ...
        table_tag_names(TAB_TAG_NAMES,
                        {
                            { "id", ColDefinition::Type::ID },
                              QString("name VARCHAR(%1) NOT NULL").arg(Configuration2::Constraints::database_tag_name_len),
                              "type INT NOT NULL"
                        },
                        {
        ...
        table_tags(TAB_TAGS,
                   {
                       { "id", ColDefinition::Type::ID },
                         QString("value VARCHAR(%1)").arg(Configuration2::Constraints::database_tag_value_len),
