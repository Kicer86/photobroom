...
TEST(SqlFilterQueryGeneratorTest, FiltersPhotosByNotRegularRole)
{
    Database::SqlFilterQueryGenerator generator;
    std::deque<Database::IFilter::Ptr> filters;

    auto filter = std::make_shared<Database::FilterPhotosWithRole>(Database::FilterPhotosWithRole::Role::Regular, true);
...
TEST(SqlFilterQueryGeneratorTest, FiltersPhotosByNotGroupRepresentativeRole)
{
    Database::SqlFilterQueryGenerator generator;
    std::deque<Database::IFilter::Ptr> filters;

    auto filter = std::make_shared<Database::FilterPhotosWithRole>(Database::FilterPhotosWithRole::Role::GroupRepresentative, true);
...
TEST(SqlFilterQueryGeneratorTest, FiltersPhotosByNotGroupMemberRole)
{
    Database::SqlFilterQueryGenerator generator;
    std::deque<Database::IFilter::Ptr> filters;

    auto filter = std::make_shared<Database::FilterPhotosWithRole>(Database::FilterPhotosWithRole::Role::GroupMember, true);
