...
TEST_F(FlatModelTest, dataReplacementInTheMiddle)
{
    EXPECT_CALL(backend, getPhotos(_))
        .WillOnce(Return(std::vector<Photo::Id>{Photo::Id(1), Photo::Id(2), Photo::Id(3)}))                 // first call after db set
        .WillOnce(Return(std::vector<Photo::Id>{Photo::Id(1), Photo::Id(4), Photo::Id(3)}));                // second call after setting filters
...
TEST_F(FlatModelTest, dataReplacementAtFront)
{
    EXPECT_CALL(backend, getPhotos(_))
        .WillOnce(Return(std::vector<Photo::Id>{Photo::Id(1), Photo::Id(2), Photo::Id(3)}))                 // first call after db set
        .WillOnce(Return(std::vector<Photo::Id>{Photo::Id(4), Photo::Id(2), Photo::Id(3)}));                // second call after setting filters
...
TEST_F(FlatModelTest, dataReplacementAtBack)
{
    EXPECT_CALL(backend, getPhotos(_))
        .WillOnce(Return(std::vector<Photo::Id>{Photo::Id(1), Photo::Id(2), Photo::Id(3)}))                 // first call after db set
        .WillOnce(Return(std::vector<Photo::Id>{Photo::Id(1), Photo::Id(2), Photo::Id(4)}));                // second call after setting filters
