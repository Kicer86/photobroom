...
struct ITagsOperator
{
    ...
    virtual void setTag(const TagTypeInfo &, const TagValue &) = 0;             // set tag to value
    virtual void setTags(const Tag::TagsList &) = 0;                            // set list of tags
    virtual void insert(const TagTypeInfo& name, const TagValue &) = 0;         // set or update exisiting tag
};
